    ...
    <>
      {openHelp
        ? <section className="flex flex-col items-center absolute z-10 top-0 left-0 w-[36rem] h-screen justify-between py-8 bg-lime-900">
          <button className="absolute top-0 right-0 m-6 border px-2 py-1 rounded-full my-4 hover:bg-green-900" onClick={() => setOpenHelp(false)}>X</button>
        ...
        : <button className="absolute top-0 left-0 m-8 border py-1 px-2 rounded-md hover:bg-green-900" onClick={() => setOpenHelp(true)}>Ayuda</button>
      }
